...
- You can style the mask using the amp-sidebar-maskclass in css. The 'opacity' and 'background-color' of 'amp-sidebar-mask' may be set to adjust the opacity and background color of the mask.
